// This file is almost entirely copied from https://github.com/tangrams/harfbuzz-example/blob/master/src/freetypelib.h
// I downloaded, used and modified this file under the MIT License.
...
Glyph* FreeTypeLib::rasterize(FT_Face* face, uint32_t glyphIndex) const {
    ...
    g->bearing_y = (float) slot->bitmap_top;
